...
<div class="inner-page">
    <div class="slider-item overlay" style="background-image: url('images/dairy_12.jpg');background-size:1550px 800;"
...
try{
	...
	if(rs.next()){
		%>
                ...
                <input type="text" name="fname" class="form-control " value="<%=rs.getString(2)%>">
              
                <label for="name">LastName</label>
                <input type="text" name="lname" class="form-control mb-3" value="<%=rs.getString(3)%>">
                
                <label for="date">Date OF Birth</label>
                <input type="date" name="dob" class="form-control mb-3" value="<%=rs.getDate(4)%>">
                
                <label for="phone">Mobile Number</label>
                <input type="tel" name="phone" pattern="[6-9]{1}[0-9]{9}" class="form-control mb-3" value="<%=rs.getLong(5)%>">
                
                <label for="address">Address</label>
                <input type="text" name="address" class="form-control mb-3" value="<%=rs.getString(6)%>">
                ...
                <label>Pincode</label>
                <input type="tel" name="pcode" maxlength="6" class="form-control mb-3" value="<%=rs.getLong(8)%>">
                
                    
                <input type="submit" value="Update" class="btn btn-primary px-3 py-3 mb-3">
