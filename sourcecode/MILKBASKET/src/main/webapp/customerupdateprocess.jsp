...
<%@include file="connect.jsp" %>
	...
	PreparedStatement ps=con.prepareStatement("update reg set fname=?,lname=?,dob=?,phone=?,address=?,city=?,pcode=? where email=? and  id=?");
		...
		if(sss>0){
			...
			<jsp:include page="customerprofileprocess.jsp"/>
			<% 
		}
		else{
			%>
